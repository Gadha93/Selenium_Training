...
public class FlightTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String actual = driver.findElement(By.xpath("//div[@class='Text-module__root--variant-headline_1___15NFj']"))
				.getText();
		...
		Thread.sleep(2000);
//driver.findElement(By.cssSelector(".css-fmz2v-inputGroup")).click();
//driver.findElement(By.xpath("//input[@placeholder='Where from?'and @readonly type='text']")).click();
//Thread.sleep(2000);
